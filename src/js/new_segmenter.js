...
export function Document(props) {
  ...
  function Sentence(props) {
	...
	function Token(props) {
		...
		return (
			props.index === 0
				? <span className="" key={props.id} onMouseEnter={enterToken} onMouseLeave={leaveToken}><span className="token">{props.form.value}</span></span>
				: (
					<span className={tokenAreaClassName}
